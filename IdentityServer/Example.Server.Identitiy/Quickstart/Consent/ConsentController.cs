// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConsentController.cs" company="GSD Logic">
...
namespace Example.Server.Identity.Quickstart.Consent
{
    ...
    using Example.Server.Identity.Quickstart.Account;
    ...
    public class ConsentController : Controller
    {
        ...
        private async Task<ProcessConsentResult> ProcessConsent(ConsentInputModel model)
        {
            ...
            if (model.Button == "no")
            {
                ...
                // emit event
                await this._events.RaiseAsync(new ConsentDeniedEvent(this.User.GetSubjectId(), result.ClientId, request.ScopesRequested));
            }
